...
var SQLitePluginTransaction = function(db, fn, error, success, txlock, readOnly) {
...
SQLitePluginTransaction.prototype.addStatement = function(sql, values, success, error) {
  ...
  if (!!values && values.constructor === Array) {
    for (j = 0, len1 = values.length; j < len1; j++) {
      v = values[j];
      t = typeof v;
      params.push((v === null || v === void 0 || t === 'number' || t === 'string' || t === 'boolean' ? v : v instanceof Blob ? v.valueOf() : v.toString()));
    }
  }
  this.executes.push({
    success: success,
  ...
  handlerFor = function(index, didSucceed) {
    return function(response) {
      ...
      try {
        ...
        console.log("warning - exception while invoking a callback: "+JSON.stringify(_error));
      }
